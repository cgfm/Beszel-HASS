...
class BeszelBinarySensor(CoordinatorEntity[BeszelDataUpdateCoordinator], BinarySensorEntity):
    ...
    def is_on(self) -> bool | None:
        ...
        if "stats" in system_data and system_data["stats"] is not None:
            return True
        
        # If stats is None but no error, system might be offline
